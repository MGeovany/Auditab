...
/*
describe('Test for Navbar links', () => {
  test('The About button is available', () => {
    render(<Navbar/>)

    expect(screen.getByText('About').closest('Link')).toHaveAttribute('to', '/about')
  })
...
describe('header width', () => {
  test('figure it out jeje', () => {
    ...
    const divNavbar = screen.getByTestId('head')
    expect(getComputedStyle(divNavbar).height).toBe('90px')
  })
})
*/
