        ...
        <div className='card-corner flex'>
          <div className='card-image'>
            ...
            <div className='card-content flex'>
              ...
              <p className='card-text line'> Save hundreds of admin hours by reducing back and forth </p>
              <hr></hr>
              <span>
               <h3>Read More</h3>
              </span>
        ...
        <div className='card-corner flex'>
          <div className='card-image'>
            ...
            <div className='card-content flex'>
              ...
              <p className='card-text line'>Modern, user-friendly software that doesn’t require any training.</p>
              <hr></hr>
              <span>
               <h3>Read More</h3>
              </span>
